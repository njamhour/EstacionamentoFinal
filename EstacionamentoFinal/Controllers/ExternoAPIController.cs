using EstacionamentoFinal.ServiceReferenceCEP;
using System;
...
{
    public class ExternoAPIController : Controller
    {
        // GET: ExternoAPI
        ...
        public JsonResult BuscaCep(string CepSaida, string CepEntrada)
        {
            ...
            string sCepOrigem = CepSaida;
            string sCepDestino = CepEntrada;
